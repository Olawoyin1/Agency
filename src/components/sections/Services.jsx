...
export default function Services() {
    ...
    return (
        <section id="services" className="py-32 md:py-40 px-6 md:px-12 w-full bg-[#FAF9F6] relative z-[30]">
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row justify-between mb-24 lg:mb-32 gap-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, idx) => (
                        <motion.div
                            ...
                            className="bg-white p-12 rounded-[40px] border border-[#EAE8E3] hover:border-[#1A1A1A] transition-all duration-500 group cursor-pointer shadow-sm hover:shadow-xl flex flex-col"
                        >
                            ...
                            <h3 className="text-3xl font-bold tracking-tight mb-5 text-[#1A1A1A]">{service.title}</h3>
